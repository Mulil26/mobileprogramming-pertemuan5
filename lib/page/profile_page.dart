...
class ProfilePage extends StatefulWidget {
  ...
  const ProfilePage({super.key,required this.jobs, required this.onDelete, required this.onRespond,});
                            ...
                            onPressed: () {
                              SimpleAlertDialog.show(
                                ...
                                onConfirmButtonPressed: (ctx) {
                                  widget.onDelete(index); // hapus data
                                  CherryToast.success(
